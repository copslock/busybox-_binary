...
IF_E2FSCK(APPLET_ODDNAME(fsck.ext2, e2fsck, BB_DIR_SBIN, BB_SUID_DROP, e2fsck))
IF_E2FSCK(APPLET_ODDNAME(fsck.ext3, e2fsck, BB_DIR_SBIN, BB_SUID_DROP, e2fsck))
...
IF_MKE2FS(APPLET_ODDNAME(mke2fs, mke2fs, BB_DIR_SBIN, BB_SUID_DROP, mke2fs))
...
IF_MKE2FS(APPLET_ODDNAME(mkfs.ext2, mke2fs, BB_DIR_SBIN, BB_SUID_DROP, mke2fs))
IF_MKE2FS(APPLET_ODDNAME(mkfs.ext3, mke2fs, BB_DIR_SBIN, BB_SUID_DROP, mke2fs))
